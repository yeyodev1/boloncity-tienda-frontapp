...
export type BranchForm = { name: string; city: string; address: string; phone: string; email: string; googleMapsUrl: string; isActive: boolean; openingHours: OpeningHours[]; imageFile: File | null; imagePreview: string }
