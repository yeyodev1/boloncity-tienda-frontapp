...
/* El modo marca solo pinta el SIDEBAR de verde. Estas variables no deben llegar al
   contenido: si --admin-text queda blanco a nivel del shell, todos los textos de las
   vistas (paneles blancos) se vuelven ilegibles. */
.admin-shell[data-mode='brand'] .admin-sidebar { --admin-sidebar: #173e22; --admin-mode: rgba(255,255,255,.08); --admin-line: rgba(255,255,255,.12); --admin-text: #fff; --admin-muted: rgba(255,255,255,.65); --admin-hover: rgba(255,255,255,.1); --admin-accent: #00a523; }
