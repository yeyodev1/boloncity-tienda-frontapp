      ...
      <div class="auth-visual">
        ...
        <div class="auth-visual__content">
          ...
          <div class="auth-visual__text">
            <span class="auth-visual__eyebrow">Empieza aquí</span>
            <h1 class="auth-visual__title">Tu próxima compra más fácil</h1>
            <p class="auth-visual__desc">Crea tu cuenta para pedir tus bolones, tigrillos, bebidas y combos favoritos con menos pasos.</p>
          </div>
      ...
      <div class="auth-card-wrap">
        <div class="auth-card">
          <div class="auth-card__head">
            ...
            <h2 class="auth-card__title">Registro</h2>
            <p class="auth-card__desc">Déjanos tus datos principales y empieza a pedir desde la tienda en línea de Boloncity.</p>
          </div>
          ...
          <form class="auth-form" @submit.prevent="submit">
            ...
            <button class="auth-submit" type="submit" :disabled="loading || !name || !email || !password">
